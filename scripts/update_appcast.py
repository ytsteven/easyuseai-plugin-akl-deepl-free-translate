...
def update_appcast(message):
    ...
    release_file = Path(f"release/easyuseai-plugin-akl-deepl-free-translate.aiplugin")
    ...
    version_info = {
        ...
        "desc": message,
        "sha256": file_hash,
        "url": f"https://github.com/akl7777777/bob-plugin-akl-deepl-free-translate/releases/download/v{version}/bob-plugin-akl-deepl-free-translate_v{version}.aiplugin",
        "minBobVersion": "0.5.0"
    }
